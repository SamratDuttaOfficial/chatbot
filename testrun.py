...
docs_y = [] #List of all the tags for specific question_patterns.

for intent in dataset["intents"]:
    for pattern in intent["question_patterns"]: #Stems the words. Finds the root of the word. Removes extra characters and symbols to find the root word. 
...
def chat():
    print("Start talking (Enter 'quit' to stop)")
    while True:
        inp = input("You: ")
        if inp.lower() == "quit":
            break
